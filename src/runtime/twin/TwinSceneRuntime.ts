...
import type { ViewerInteractionEvent, ViewerSelection } from '@/components/twin/viewerContract'
...
import { BindingTargetResolver, bindingTargetFromObject } from '@/editor/services/BindingTargetResolver'
