...
import type { ViewerInteractionEvent, ViewerTargetClick } from '@/components/twin/viewerContract'
import type { BindingTargetResolver } from '@/editor/services/BindingTargetResolver'
